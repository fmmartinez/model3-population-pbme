...
he%gg(inig:lasg,inib:lasb) = eg*s%gb(1:ng,1:nb) + 0.5d0*(k%gb(1:ng,1:nb) + omega**2*vg%gb(1:ng,1:nb))
he%gg(inig:lasg,inid:lasd) = eg*s%gd(1:ng,1:nd) + 0.5d0*(k%gd(1:ng,1:nd) + omega**2*vg%gd(1:ng,1:nd))
!
he%gg(inib:lasb,inig:lasg) = eg*s%bg(1:nb,1:ng) + 0.5d0*(k%bg(1:nb,1:ng) + omega**2*vg%bg(1:nb,1:ng))
he%gg(inib:lasb,inib:lasb) = eg*s%bb(1:nb,1:nb) + 0.5d0*(k%bb(1:nb,1:nb) + omega**2*vg%bb(1:nb,1:nb))
he%gg(inib:lasb,inid:lasd) = eg*s%bd(1:nb,1:nd) + 0.5d0*(k%bd(1:nb,1:nd) + omega**2*vg%bd(1:nb,1:nd))
!
he%gg(inid:lasd,inig:lasg) = eg*s%dg(1:nd,1:ng) + 0.5d0*(k%dg(1:nd,1:ng) + omega**2*vg%dg(1:nd,1:ng))
he%gg(inid:lasd,inib:lasb) = eg*s%db(1:nd,1:nb) + 0.5d0*(k%db(1:nd,1:nb) + omega**2*vg%db(1:nd,1:nb))
he%gg(inid:lasd,inid:lasd) = eg*s%dd(1:nd,1:nd) + 0.5d0*(k%dd(1:nd,1:nd) + omega**2*vg%dd(1:nd,1:nd))
!
!(g|b)
...
!
!(b|b)
he%bb(inig:lasg,inig:lasg) = eb*s%gg(1:ng,1:ng) + 0.5d0*(k%gg(1:ng,1:ng) + omega**2*vb%gg(1:ng,1:ng))
he%bb(inig:lasg,inib:lasb) = eb*s%gb(1:ng,1:nb) + 0.5d0*(k%gb(1:ng,1:nb) + omega**2*vb%gb(1:ng,1:nb))
he%bb(inig:lasg,inid:lasd) = eb*s%gd(1:ng,1:nd) + 0.5d0*(k%gd(1:ng,1:nd) + omega**2*vb%gd(1:ng,1:nd))
!
he%bb(inib:lasb,inig:lasg) = eb*s%bg(1:nb,1:ng) + 0.5d0*(k%bg(1:nb,1:ng) + omega**2*vb%bg(1:nb,1:ng))
he%bb(inib:lasb,inib:lasb) = eb*s%bb(1:nb,1:nb) + 0.5d0*(k%bb(1:nb,1:nb) + omega**2*vb%bb(1:nb,1:nb))
he%bb(inib:lasb,inid:lasd) = eb*s%bd(1:nb,1:nd) + 0.5d0*(k%bd(1:nb,1:nd) + omega**2*vb%bd(1:nb,1:nd))
!
he%bb(inid:lasd,inig:lasg) = eb*s%dg(1:nd,1:ng) + 0.5d0*(k%dg(1:nd,1:ng) + omega**2*vb%dg(1:nd,1:ng))
he%bb(inid:lasd,inib:lasb) = eb*s%db(1:nd,1:nb) + 0.5d0*(k%db(1:nd,1:nb) + omega**2*vb%db(1:nd,1:nb))
he%bb(inid:lasd,inid:lasd) = eb*s%dd(1:nd,1:nd) + 0.5d0*(k%dd(1:nd,1:nd) + omega**2*vb%dd(1:nd,1:nd))
!
!(b|d)
...
!
!(d|d)
he%dd(inig:lasg,inig:lasg) = ed*s%gg(1:ng,1:ng) + 0.5d0*(k%gg(1:ng,1:ng) + omega**2*vd%gg(1:ng,1:ng))
he%dd(inig:lasg,inib:lasb) = ed*s%gb(1:ng,1:nb) + 0.5d0*(k%gb(1:ng,1:nb) + omega**2*vd%gb(1:ng,1:nb))
he%dd(inig:lasg,inid:lasd) = ed*s%gd(1:ng,1:nd) + 0.5d0*(k%gd(1:ng,1:nd) + omega**2*vd%gd(1:ng,1:nd))
!
he%dd(inib:lasb,inig:lasg) = ed*s%bg(1:nb,1:ng) + 0.5d0*(k%bg(1:nb,1:ng) + omega**2*vd%bg(1:nb,1:ng))
he%dd(inib:lasb,inib:lasb) = ed*s%bb(1:nb,1:nb) + 0.5d0*(k%bb(1:nb,1:nb) + omega**2*vd%bb(1:nb,1:nb))
he%dd(inib:lasb,inid:lasd) = ed*s%bd(1:nb,1:nd) + 0.5d0*(k%bd(1:nb,1:nd) + omega**2*vd%bd(1:nb,1:nd))
!
he%dd(inid:lasd,inig:lasg) = ed*s%dg(1:nd,1:ng) + 0.5d0*(k%dg(1:nd,1:ng) + omega**2*vd%dg(1:nd,1:ng))
he%dd(inid:lasd,inib:lasb) = ed*s%db(1:nd,1:nb) + 0.5d0*(k%db(1:nd,1:nb) + omega**2*vd%db(1:nd,1:nb))
he%dd(inid:lasd,inid:lasd) = ed*s%dd(1:nd,1:nd) + 0.5d0*(k%dd(1:nd,1:nd) + omega**2*vd%dd(1:nd,1:nd))
!
!final accomodation
